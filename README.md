...
12. Creat Product Details Screen
...
19. Connect to MongoDB Database
    1. create atlas mogodb database
...
33. Publish To Heroku
    ...
    5. create mogodb atlas database
...
48. Edit user
    1. create edit button
    2. create edit product ui
    3. diplay product info in the input boxes
...
51. Skipping 51 (Emails)
52. Review Orders
    1. create submit review form
    2. handle submit
    3. implement backend api for review
53. Reversed 50 and 52
    1. 50 wasn't working due to deprecation
    2. 52-Review Orders wasn't needed
    3. This will be template for e-commerce apps
